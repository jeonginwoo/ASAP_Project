...
#ㄱ,ㄴ,ㄷ
word_a = ['가격','갈릭불고기와퍼','갑각류알레르기','강판치즈','계란알레르기','구운갈릭시즈닝','나트륨','너겟킹','단백질',
     '달걀알레르기','닭','당','더블비프불고기버거','더블오리지날치즈버거','돼지고기알레르기','돼지알레르기','디아블로', '너겟'
     '디아블로소스','디아블로소스','디저트','드링크','고기','두개','두','둘','네개','넷','네','다섯개','다섯','단백질','나트륨','그람',
     '그램','들었','감사합니다','고마워','감사']
#ㄹ,ㅁ
...
word_e = ['아메리카노','아이스아메리카노','아이스','아이스초코','아이스크림','안맵','알러지','알레르기','알레르기','양상추','양파',
     ...
     '아홉','열개','열','주세요','요','얼마나','열량'
     ]
#ㅊ
word_f = ['초코망고선데', '치즈', '치즈소스', '치즈스틱', '치즈와퍼', '치즈와퍼주니어', '치즈프라이', '치즈프라이',
     '치킨', '치킨버거', '치킨버거', '치킨알레르기', '치킨와퍼', '치킨킹', '치킨킹BLT','초코'] 
#ㅋ
...
class Leven():
    def __init__(self,text):
        ...
        self.stop_words = '은 는 이 가 에 에는 을 를 에서 으로 의 에게 께 에게 과 와 에는'
