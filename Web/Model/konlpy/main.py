...
class Konlp():
    ...
    # 바꿀 단어들을 사전 형태로 정의
        ...
        self.toQ = {'칼로리': 'N_calories','포화지방': 'N_saturated_fat','단백질': 'N_protein','당': 'N_sugars','설탕': 'N_sugars','나트륨': 'N_sodium','카페인':'N_caffeine',
            ...
            '햄버거':'M','버거':'M','아침':'M','점심':'M','저녁':'M','메뉴':'M','음식':'M','끼니':'M','배고프':'M',
            '사이드':'S','디저트':'DD','음료수':'DD','아이스크림':'DD','높':'desc','낮':'asc','많':'desc','적':'asc'}
        ...
        self.etc = ['영양소','영양성분','알레르기','가격','정보','상세정보','맵기','맵','안맵','nutrition_info','allergy',
            'N','A','price','info','spicy','높','많','낮','적']
        self.cat = ['M','S','DD','햄버거','버거','사이드','디저트','음료수','아이스크림','아침','점심','배고프','저녁','메뉴','음식','끼니']
